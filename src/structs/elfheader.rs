...
impl ElfHeader {
    ...
    pub fn print(&self) {
        ...
        println!("\tEntry point:\t\t\t{}", &self.e_entry);
        println!("\tProgram header:\t\t\t{} (offset)", &self.e_phoff);
        println!("\tSection header:\t\t\t{} (offset)", &self.e_shoff);
    ...
    pub fn program_header_offset(&self) -> Offset {
        self.e_phoff
    }
